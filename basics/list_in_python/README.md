...
La clase list en Python es una de las más utilizadas por su naturaleza, dinamismo, fácil manejo y potencia. Para esta parte los ejemplos o bloques de código los encuentras en la el directorio **ficheros** con el nombre: list.py
...
El código anterior es equivalente a $del letters[:]$
...
![](https://raw.githubusercontent.com/gabrielfernando01/basics_in_python/master/image/list.png)![](https://raw.githubusercontent.com/gabrielfernando01/basics_in_python/master/image/header_python.png)
